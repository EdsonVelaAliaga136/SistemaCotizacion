...
<%
    if (request.getParameter("registrar") != null) {
        String mensaje = material.registrarMaterial(request);
        out.print(mensaje);
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="h4">Registrar Material</h3>
                </div>
                <div class="card-body">
                    ...
                    <form class="form-horizontal">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="inputHorizontalSuccess" type="text"  name="desc" placeholder="Material" class="form-control form-control-success">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 form-control-label">Unidad de medida:</label>
                            <div class="col-sm-9">
                                <input id="inputHorizontalWarning" type="text" placeholder="Unidad de Medida" name="uniMed"  class="form-control form-control-warning">
                            </div>
                        </div>
                        <div class="form-group row">
